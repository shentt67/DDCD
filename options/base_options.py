...
class BaseOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--cuda_num', type=int, default=3, help="GPU number")
        ...
        parser.add_argument('--Lambda', type=float, default=0.006)
        parser.add_argument('--alpha', type=float, default=1)

        parser.add_argument('--type_norm', type=str, default="None", help='{None, batch, group, pair}')
        parser.add_argument('--DDCD', help='Use DDCD', type=ast.literal_eval, dest='DDCD')
